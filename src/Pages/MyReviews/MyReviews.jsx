  ...
  return (
    <div>
          ...
          return (
            ...
            className="max-w-md p-2 mx-auto md:hidden border-2 my-10  bg-gray-100 rounded-md">
              ...
              <div className="flex justify-evenly mt-3">
                <p className="text-green-500 hover:text-green-700 flex items-center border-2 px-2 rounded-md">
                  <FaEdit className="mr-1" /> Edit
                </p>
                <p className="text-red-500 hover:text-red-700 flex items-center border-2 px-2 rounded-md">
      ...
      <div className="hidden md:block my-10 mx-5">
        ...
        : <div className="w-full h-[100vh] flex justify-center items-center text-3xl font-bold text-red-400"><h2>No reviews found</h2></div>
      }
    </div>
  );
}
